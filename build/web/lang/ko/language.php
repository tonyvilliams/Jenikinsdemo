...
"Error creating account" => "계정 생성 오류",
...
"TextLink and ForwardLink created.." => "TextLink 와 ForwardLink 생성됨..",
"New File" => "새 파일",
"(external link)" => "(외부 링크)",
...
"created the subcategory" => "하위범주가 생성됨",
...
"Email must be specified" => "이메일은 반드시 지정되어야만 합니다",
"Title is empty" => "제목이 비어잇음",
...
"Feature disabled" => "기능 사용 안 함",
"Reserved to administrators during development" => "개발 중 관리자에게 예약됨",
"registration" => "등록",
"confirmation" => "확인",
"Connect Feature disabled" => "연결 기능 사용 안 함",
"Connect Server Mode disabled" => "연결 서버 모드사용 안 함",
...
"Upload from source disabled" => "소스에서 업로드 사용 안 함",
"Manual refresh disabled" => "수동 다시 고침 비활성화됨",
...
"Workspaces" => "작업공간",
"Could not create workspace root" => "작업공간 루트를 생성할 수 없었습니다",
...
"Created by profile installer" => "프로필 설치기에 의해 생성됨",
...
"Create a form which will be posted somewhere, not necessarily trackers or even Tiki" => "어딘가에 게시될 서식을 생성, 반드시 트래커 혹은 티키가 아닐 수도 있음",
"Post" => "게시",
"Script" => "스크립트",
...
"Freetags" => "프리태그",
"Allows freetags to be shown or added for tracker items" => "프리태그가 트래커 항목에 대하여 보여지거나 추가되는 것을 허용함",
"Visible size of the input field" => "입력 필드의 보이는 크기",
"Hide or show the input help" => "입력 도움말을 감추거나 보이기",
"Show" => "보기",
"Hide" => "숨김",
"Suggest" => "제안",
"Hide or show the freetag suggestions" => "프리태그 제안을 감추거나 보이기",
...
"For no autoaassigned field, the user (user selector if exsits or user) will be assigned to the group and it will be his default group. The group must have the user choice setting on" => "자동할당된 필드가 없으면, 사용자 (기존의 사용자 선택기 혹은 사용자) 가 그룹으로 할당될 것이며 그리고 이는 그 사람의 기본 그룹이 됩니다. 그룹은 반드시 사용자 선택 설정이 켜져있어야만 합니다",
"Assign" => "할당",
"Header" => "머리글",
...
"Create Page" => "페이지 생성",
"Create missing pages using the page name in this file as the template" => "이 파일 내의 페이지명을 사용하여 템플릿으로 없는 페이지들을 생성",
...
"Creates a link to a specified URL" => "지정된 URL로 링크 생성됨",
...
"Assign the value based on the creator or modifier" => "생성자 혹은 수정자에 기반하여 값 할당",
...
"Importation completed" => "불러오기 완료됨",
...
"Page \"%0\" sucessfully imported" => "\"%0\" 페이지 성공적으로 불러오기 됨",
"Post \"%0\" sucessfully imported" => "게시물 \"%0\" 이 성공적으로 불러오기 됨",
...
"NOT importing file %0 as there is already a file with the same name in the destination directory (%1)" => "파일 %0 은 목표 디렉터리 (%1) 내의 동일한 이름의 파일이 이미 있으므로 불러오기 안함",
...
"Error while parsing revision %0 of the page \"%1\". Or there is a problem on the page syntax or on the Text_Wiki parser (the parser used by the importer)" => "\"%1\" 페이지의 의 %0 수정판을 구문분석 하는 도중 오류 . 혹은 페이지 구문 상 또는 Text_Wiki 구문분석기 (불러오기 프로그램에 의해 사용되는 구문분석기) 상에 오류가 있습니다",
"Page \"%0\" successfully parsed with %1 revisions (from a total of %2 revisions)" => "\"%0\" 페이지가 %1 수정내역과 함께 성공적으로 구문분석됨 (총 %2 개의 수정내역에서)",
"Page \"%0\" is NOT going to be imported. It was not possible to parse any of the page revisions" => "\"%0\" 페이지는 불러오기가 되지 않을 것입니다. 페이지 수정내역 어느 것도 구문분석이 가능하지 않았습니다",
...
"No attachments found to import! Make sure you have created your XML file with the dumpDump.php script and with the option --uploads. This is the only way to import attachment" => "가져오기 할 첨부파일이 발견되지 않음! XML 파일을 dumpDump.php 스크립트와 --uploads 선택사항과 함께 생성하였는지 확인하십시오. 첨부파일을 가져오기 할 유일한 방법입니다",
...
"Page %0 NOT imported (there was already a page with the same name)" => "%0 페이지 불러오기 안 됨 (동일한 이름의 페이지가 이미 있습니다)",
...
"layer" => "레이어",
"Record" => "기록",
"This feature is disabled" => "이 기능은 사용 안 함",
"Could not create \$tdo.mif in data directory" => "데이터 디렉터리에 \$tdo.mif 를 생성할 수 없었습니다",
"Could not create \$tdo.mid in data directory" => "데이터 디렉터리에 \$tdo.mid 를 생성할 수 없었습니다",
...
"A wiki page is created, deleted or edited, except for minor changes." => "위키 페이지가 생성, 삭제 및 편집 됨, 사소한 변경은 제외.",
"A wiki page is created, deleted or edited, even for minor changes." => "위키 페이지가 생성, 삭제 혹은 편집 됨, 사소한 변경도 포함.",
...
"Create user if not in Tiki" => "티키에 없다면 사용자 생성",
...
"A maximum duration for the meetings must be provided to BigBlueButton to prevent the recordings to be excessively long if a user leaves the window open too long" => "사용자가 창을 너무 오랫동안 열린 상태로 둘 경우 녹화가 과다하게 길어지는 것을 방지하기 위하여 회의에 대한 최대 기간이 빅블루버튼에 반드시 제공되어야만 합니다",
"minutes" => "분",
"Default ordering" => "기본 순서",
...
"MapServer" => "지도서버",
"Navigable, interactive maps with user-selectable layers" => "사용자가 선택가능한 레이이를 보유한 탐색 가능한 상호작용 적 지도",
...
"If disabled, pictures will be stored in ../img/wiki_up/.. instead." => "사용 안 함의 경우, 그림은 대신 ../img/wiki_up/.. 에 저장됩니다.",
...
"allow showing forbidden (restricted) items in search result" => "검색 결과 내에 금지된 (제한된) 항목 보이기 허용",
...
"If disabled, replies will quote the original post" => "사용 안 함의 경우, 댓글이 게시물 원본을 인용합니다",
...
"Undo" => "복구",
"Footnotes" => "각주",
"Create private notes for a page that are visible only by the author" => "저자에게만 보이는 페이지에 대한 개인 메모 생성",
...
"Create webhelp from structure" => "구조체에서 웹도움말 생성",
...
"Show/Hide before Headings" => "제목 전에 보이기/감추기",
"Display show/hide icon displayed before headings" => "제목 앞에 표시되는 보이기/감추기 아이콘 표시",
...
"Use jCapture applet to create screencasts and capture screenshots" => "스크린캐스트를 생성하고 스크린샷을 캡쳐하기 위하여 jCapture 애플릿 사용",
...
"Last posts to weblogs" => "웹로그로의 마지막 게시물",
...
"Last posts to this forum. " => "이 게시판의 마지막 게시물",
...
"Uses flagged revisions to hide unapproved wiki page revisions from users with lower privileges" => "낮은 권한을 가진 사용자들로부터 미승인 위키 페이지 수정내역을 감추기 위해서 플래그지정된 수정 기능을 사용",
...
"Most titles are left untouched because they are a direct reply to the parent thread. This feature hides the title altogether from the forms and display" => "대부분의 제목들은 소대지 않은 상태고 남겨지며 그 이유는 이들이 부모 대화목록에 대한 직접적 댓글이기 때문입니다. 이 기능은 형식들과 표시 모두에서 제목을 감추게 됩니다",
"Force title in reply" => "댓글에 제목 강요",
"Shows a blank title box and requires it to be filled before submission of forum post" => "비어있는 제목 상자를 보여주고 게시판 게시물을 제출하기 전에 채워지도록 요구",
...
"Number of Tags to show in Tag Suggestions" => "태그 제안에서 보여질 태그의 수",
...
"Create the user" => "사용자 생성",
"Deny access" => "접근 거부",
"Create user if not in LDAP" => "LDAP에 없다면 사용자 생성",
...
"Hide pagination when there is only one page" => "한 페이지만 있을 경우 페이지 매김 감추기",
"Use Icons" => "아이콘 사용",
...
"Wiki page where the profile for creating orders is (page name must be without spaces)" => "주문을 생성하기 위한 프로필이 있는 위키 페이지 (페이지명에는 스페이스가 없어야 함)",
"Order Item Profile" => "주문 항목 프로필",
"Wiki page where the profile for creating orders items is (page name must be without spaces)" => "주문 항목 생성을 위한 프로필이 있는 위키 페이지 (페이지명에는 스페이스가 없어야 함)",
...
"Wiki page where the profile for creating orders for Anonymous users is (page name must be without spaces)" => "익명 사용자를 위한 주문을 생성하기 위한 프로필이 있는 위키 페이지 (페이지명에는 스페이스가 없어야 함)",
"Anonymous Order Item Profile" => "익명 주문 항목 프로필",
"Wiki page where the profile for creating orders items for Anonymous users is (page name must be without spaces)" => "익명 사용자를 위한 주문 항목 생성을 위한 프로필이 있는 위키 페이지 (페이지명에는 스페이스가 없어야 함)",
...
"Hide toolbar for textarea fields in surveys" => "설문조사 내에서 텍스트영역 필드를 위한 툴바 감추기",
...
"Default group" => "기본 그룹",
"Create with default group" => "기본 그룹으로 생성",
...
"Note, all permissions are granted to the Admins group including this one, so if you enable this you may expose your site to XSS (Cross Site Scripting) attacks for admin users" => "주의하십시오, 모든 권한들은 이를 포함한 관리 그룹에 허용됩니다, 그러므로 이를 활성화할 경우 귀하의 사이트를  관리 사용자에 대하여 XSS (교차 사이트 스크립팅) 공격에 노출할 수 잇습니다",
...
"Large values (> 10) are best for batch index creation, and smaller values (< 10) for indices that are interactively maintained" => "큰 값들 (> 10) 이 일괄 색인 만들기 용으로 최고입니다, 그리고 적은 값들 (< 10) 은 상호작용적으로 유지되는 색인용입니다",
...
"Create watch for author on page creation" => "페이지 생성 시 저자를 위해 주시 생성",
...
"Disabled by host" => "호스트에 의하여 사용 안 함",
"Actions" => "조작",
"Admin" => "관리",
"Permissions" => "권한",
"View" => "표시",
...
"Create New File Gallery" => "새 파일 갤러리 생성",
...
"Create a new image gallery" => "새 그림 갤러리 생성",
...
"Create a new wiki page" => "새 위키 페이지 생성",
...
"For you to vote, cookies must be allowed" => "투표하려면, 쿠키가 허용되어야만 합니다",
"Simple" => "단순",
"Advanced" => "고급",
...
"1) Log in with your newly created password" => "1) 새롭게 생성된 비밀번호로 로그인하십시오",
...
"(DOT)" => "(점)",
"Can create/close a book" => "장부 생성/닫기 가능",
"Can create/edit/lock accounts" => "계정 생성/편집/잠금 가능",
"Create a new transaction" => "새 거래 생성",
...
"Can create/admin calendars" => "달력 생성/관리 가능",
...
"Administrator can create channels, remove channels, etc" => "관리자는 채널 생성, 채널 삭제 등등 가능",
...
"Can create image galleries" => "그림 갤러리 생성 가능",
...
"Can admin surveys" => "설문조사 관리 가능",
"Can take surveys" => "설문 응답 가능",
"Can view survey stats" => "설문조사 통계 보기 가능",
...
"Can create new css suffixed with -user" => "-user 로 끝나는 새 css 생성 가능",
...
"Can create a new workspace for the given template" => "주어진 템플릿에 대한 새 작업공간 생성 가능",
...
"Cannot create aliased page" => "별칭의 페이지는 생성 불가",
...
"If you want to create the page, you must first edit each the pages above, and remove the alias link it may contain. This link should look something like this" => "페이지를 만드려면, 위의 각 페이지를 먼저 편집해야만 합니다, 그리고 포함되어 잇을 수 있는 별칭 링크를 삭제해야만 합니다. 이 링크는 다음과 유사하게 보여야 합니다",
...
"Text to show on the button when relation is already added" => "관계가 이미 추가되었을 때 버튼 상에 보여질 텍스트",
...
"Create an anchor that can be linked to" => "연결될 수 있는 기준 위치 생성",
...
"Creates a frame to assemble custom applications in. Components in the frame will be various wiki pages and modules" => "맞춤형 응용프로그램을 조립할 프레임을 생성. 프레임 내부의 구성 요소들이 다양항 위키 페이지 및 모듈이 될 것입니다",
...
"Hide the left column when the application frame is in use to provide more space to the application" => "응용프로그램이 사용 중인 경우, 응용 프로그램에 좀 더 많은 공간을 제공하기 위하여 좌측 열 감추기",
"Hide right column" => "우측 열 감추기",
"Hide the right column when the application frame is in use to provide more space to the application" => "응용프로그램이 사용 중인 경우, 응용 프로그램에 좀 더 많은 공간을 제공하기 위하여 우측 열 감추기",
"Full page" => "페이지 전체",
...
"List of ArticleId that must appear in this order if present" => "만약 존재한다면 이 순서대로 반드시 보여야되는 기사 ID의 목록",
...
"Url" => "URL",
"URL to be produced by the button. You can use wiki argument variables like {{itemId}} in it" => "버튼에 의해 생성될 URL. 이 내부에 {{itemId}} 와 같은 위키 인수 변수를 사용할 수 있습니다",
...
"View Type" => "유형 보기",
"Determines how to show events" => "이벤트를 어떻게 보여줄 지를 결정함",
...
"Category IDs" => "범주 ID들",
"Types" => "종류",
"Created Ascending" => "생성됨 오름차순",
"Created Descending" => "생성됨 내림차순",
...
"Categories are disabled" => "범주는 사용 안 함",
...
"Filter on fileIds in a file gallery to only show those images. Separate each fileId with ':'" => "그 그림들만 보여줄 파일갤러리 내부의 필드에 필터. 각 필드를 ':' 로 구분",
...
"Create a jQuery-UI dialog" => "jQuery-UI 대화상자 생성",
...
"Create a definition list" => "정의 목록 생성성",
"Draw" => "그리기",
...
"Exercise" => "연습",
"Creates exercises within a wiki page for students to test their new skills. The plugin allows to define inline questions and optional answers to be selected from. A score is given for multiple exercises within a page" => "학생들에게 새 능력을 시험하기 위하여 위키 페이지 내부에 연습문제를 생성합니다. 플러그인은 선택이 되어질 인라인 질문과 선택적 답안을 정의하는 것을 허용합니다. 점수는 페이지 내부의 여러 개의 연습문제에 대하여 주어짐",
"Answer" => "답",
"Incorrect" => "틀림",
...
"Label for link that shows and hides the content when clicked" => "클릭되었을 때 컨텐츠를 보이고 감추는 링크에 대한 레이블",
"Unspecified label" => "지정되지 않은 라벨",
"Arrow icon showing that content can be hidden or shown" => "컨텐츠가 감춰지거나 보여질 수 있다는 것을 나타내는 화살표 아이콘",
"Show Speed" => "속도 표시",
...
"Fancy List" => "팬시 목록",
"Create a fancy-looking list" => "화려한 목록 생성",
"Use Div" => "Div 사용",
...
"Fancy Table" => "팬시 테이블",
"Create a formatted table" => "서식적용된 테이블 생성",
...
"Wiki attachments are disabled" => "위키 첨부 사용 안 함",
...
"Footnote Area" => "각주 영역",
"Create automatically numbered footnotes (together with PluginFootnote)" => "번호 매겨진 각주를 자동 생성 (PluginFootnote 와 함께)",
"Footnote" => "각주",
"Create automatically numbered footnotes (together with PluginFootnoteArea)" => "번호 매겨진 각주를 자동 생성 (PluginFootnoteArea 와 함께)",
"The footnote" => "각주",
...
"Choose from:  objectId, type, itemId, description, created, name, href, hits, comments_locked (Default: created_desc)" => "다음에서 선택: 개체ID(objectId), 종류, 항목ID(itemId), 설명, 생성됨, 이름, href, 방문수, comments_locked (기본: created_desc)",
...
"Choose whether to show titles only (not shown by default)" => "제목만을 보여줄 것인지 선택하십시오 (기본으로 보여지지 않음)",
"Maximum Image Size" => "최대 그림 크기",
"Height or width in pixels. Default = 0 (no maximum)" => "픽셀단위 높이 혹은 너비: 기본 = 0 (최대값 없음)",
"Create a button for downloading a file from an FTP server" => "FTP 서버에서 파일을 다운로드 하기 위한 버튼 생성",
"file name" => "파일명",
"Server Name" => "서버명",
...
"Choose whether to show a border around the iframe" => "iframe 주변에 테두리를 보여줄 것인지 선택하십시오",
"Margin Height" => "여백 높이",
...
"Auto" => "자동",
"Edit Link" => "링크 편집",
"Choose whether to show an edit link and set its location" => "편집 링크를 보이기 및 위치를 설정할 것인지 선택하십시오",
...
"Choose whether to show a frame border around the map (no border shown by default)" => "지도의 주변에 프레임 테두리를 보여줄 것인지 선택 (기본으로 테두리 보여지지 않음)",
...
"Hide map if there are no markers to be shown. Default is to show the map" => "보여질 표식이 없으면 지도 감추기. 기본값은 지도를 보이기.",
"Visibility Toggle" => "표시 여부 토글",
"Add ability to toggle visibility. No toggle by default" => "보이기를 토글 가능 여부를 추가합니다. 기본으로 토글 없음입니다",
"Toggle Link Align" => "링크 맞춤 토글",
"Alignment for the show/hide toggle link" => "링크 보이기/감추기 토글에 대한 맞춤",
"Start Hidden" => "시작 숨김",
"Choose whether to keep the map hidden initially. Default is to show the map initially" => "지도를 초기에 감쳐진 상태로 유지할 것인지 선택하십시오. 기본은 초기에 지도를 보여주는 것입니다",
"Auto Zoom" => "자동 확대/축소",
...
"Field ID of tracker field if type is Item, Tracker Field or Locator, Item Type is trackeritem and Item ID is the tracker item ID. Tracker item must be categorized" => "유형이 항목, 트래커필드 혹은 취일 경우 태르커 필드의 필드 ID, 항목 유형은 트래커항목입니다 그리고 항목ID 는 트래커 항목 ID입니다. 트래커 항목은 반드시 범주화되어야만 합니다",
...
"Last Modified User Descending" => "마지막 수정된 사용자 내림차순",
...
"Enlarge" => "확대",
"''No image specified. One of the following parameters must be set: fileId, randomGalleryId, fgalId, attId, id.''" => "'그림이 지정되지 않음. 다음 매개변수들 중 하나가 설정되어야만 함: fileId, randomGalleryId, fgalId, attId, id.''",
...
"Creates a tracker item when the plugin is inserted in the page. The plugin is removed and replaced by a link to the newly created item" => "플러그인이 페이지에 삽입되었을 때 트래커 항목을 생성. 플러그인이 삭제되고 새롭게 생성된 항목으로의 링크로 교체됨",
...
"Default Group" => "규정그룹",
"Dropdown list will show this group by default" => "드롭다운 목록은 기본적으로 이 그룹을 보여줄 것입니다",
"Dropdown list will show the group related to this item ID (in group selector or creator field) by default" => "드롭다운 목록은 기본적으로 이 항목 ID와 연관된 그룹을 (그룹 선택기 혹은 만든이 필드 내부에서) 보여줄 것입니다",
...
"Create lists of Tiki objects based on custom search criteria and formatting" => "맞춤형 검색 조건과 서식에 기반한 티키 개체 목록 생성",
...
"Select Yes (y) to hide the title (default is to show the title)" => "제목을 감추려면 예 (y) 를 선택 (기본은 제목을 보여줌)",
...
"Decoration" => "장식",
"Add ability to show/hide the content of the module (default is the site admin setting for modules)" => "모듈의 컨텐츠를 표시/감추기를 할 가능 여부를 추가합니다 (기본은 모듈들에 대한 사이트 관리 설정입니다)",
...
"Effect" => "효과",
"Set the type of show/hide animation that will be used" => "사용될 애니메이션의 보이기/감추기 종류 설정",
"Effect Speed" => "스피드 효과",
...
"Information" => "정보",
"Determines what information is shown. Values separated with | . Ignored when singletitle is set to top or none" => "어떤 정보가 보여질 것인지를 결정함. 값들은  | 로 구분됨. singletitle 이 상단 혹은 없음으로 설정되었을 경우 무시됨",
...
"Number of plugins to show. Can be used either with start or plugin as the starting point. Must be an integer 1 or greater" => "보여질 플러그인의 수. 시작을 하거나 혹은 플러그인을 시작점으로써 사용될 수 있음. 반드시 정수 1 이상이어야만 함",
"Poll" => "설문",
...
"Creates a link to SourceForge tracker items" => "소스포지 트래커 항목으로 링크 생성",
"Group ID" => "그룹 ID",
...
"PCRE-compliant regular expression replacement syntax showing what the content should be changed to" => "어떤 컨텐츠가 변경되어야를 보여주는 PCRE-규격 정규 표현식 교체 문법",
...
"Added and/or viewed in the last 24 hours (only added items shown for tracker items whether a (added) or v (viewed) or both is set)" => "지난 24시간 내에 추가됨 및 방문됨 (a (추가됨) 혹은 v (방문됨) 혹은 둘 다 설정된 트래커 항목들에 대하여 추가된 항목들만 보여줌)",
"Added" => "추가됨",
...
"Last Year" => "작년",
"Added and/or viewed in the last 365 days (only added items shown for tracker items whether a (added) or v (viewed) or both is set)" => "지난 365일간 추가됨 및/혹은 봄 (추가된 항목만이 트래커 항목에 대하여 a (추가됨) 혹은 v (봄) 혹은 둘 다 설정됨 이 보여짐)",
"This Year" => "올 해",
...
"Text shown in the dropdown box. Default: \"Subscribe to a group\"" => "드롭다운 상자 내에 보여진 텍스트. 기본: \"그룹으로 구독\"",
...
"Lower Bound" => "하위 경계",
"Date from which element should be displayed. Date must be provided in YYYY-MM-DD HH:mm:ss format" => "요소가 표시될 날짜. 날짜는 반드시 YYYY-MM-DD HH:mm:ss 형식으로 제공되어야만 합니다",
"Upper Bound" => "상위 제한",
"Date until which element should be displayed. Date must be provided in YYYY-MM-DD HH:mm:ss format" => "요소가 표시될 때까지의 날짜. 날짜는 반드시 YYYY-MM-DD HH:mm:ss 형식으로 제공되어야만 합니다",
...
"Item Count" => "항목 개수",
"Determines whether the number of items will be shown (not shown by default)" => "항목의 수가 보여질 것인지 여부를 결정함 (기본으로 보여지지 않음)",
...
"Returns array non-interactively" => "배열을 비상호작용적으로 반환",
...
"Choose whether the tooltip will stay displayed on mouse out (does not stay open by default)" => "도구설명이 마우스포인터가 나와도 표기된 상태로 남아있을 것인지 선택하십시오 (기본으로는 열린 상태로 남아잇지 않습니다)",
...
"Creation date display is based on tracker settings unless overriden here" => "생성 날짜 표기는 여기에서 재정의되지 않는 한 트래커 설정에 기반함",
...
"Determines whether pagination will be shown (shown by default)" => "페이지 나눔이 보여질 것인지를 결정함 (기본으로 보여짐)",
"Filter Field" => "필드 필터",
...
"Embedded" => "포함됨",
"To send an email once the tracker item has been created. Format: from" => "트래커 항목이 생성되고 난 후 이메일을 보내려면. 형식: from",
"Email format" => "이메일 양식",
...
"Choose whether to show the percentage of the vote each option received (not shown by default)" => "각 선택사항이 받은 투표의 백분율을 보여줄 것인지 선택하십시오 (기본으로 보이지 않음)",
"Choose whether to show a bar representing the number of votes each option received (not shown by default)" => "각 선택사항이 받은 투표의 수를 나타내는 바를 보여줄 것인지 선택하십시오 (기본으로는 보이지 않는 것입니다)",
...
"Translated" => "번역됨",
"Create multi-lingual links" => "다중 언어 링크 생성",
"Flag" => "깃발",
...
"Show Stats" => "통계 표시",
"Choose whether to show the voting results (shown by default)" => "투표 결과를 보여줄 것인지 선택하십시오 (기본으로 보여줌)",
"Show Stats After" => "다음 이후 통계 표시",
"Choose whether to show the voting results only after the date given in the tracker configuration (not set by default)" => "트래커 구성에 주어진 날짜 후에만 투표 결과를 보여줄 것인지 선택하십시오 (기본으로 설정되지 않음)",
"Choose whether to display the user name of the creator of the voting tracker (not shown by default)" => "투표 트래커의 생성자의 사용자 이름을 표기할 지 선택하십시오 (기본으로 보여지지 않음)",
...
"Plugin YouTube error: the movie parameter is empty" => "유튜브 플러그인 오류: 동영상 매개 변수가 비어잇음",
...
"If set to \"y\", article publication times are shown" => "\"y\" 로 설정된 경우, 기사 개제 시간이 보여집니다",
"Show creation time" => "만든 시간 보기",
"If set to \"y\", article creation times are shown" => "\"y\" 로 설정된 경우, 기사 만든 시간이 보여집니다",
...
"View type" => "보기 유형",
"Determines how to show events. Possible values: %0, %1" => "이벤트를 어떻게 보여줄 지를 결정함. 가능한 값들: %0, %1",
...
"Detailed" => "자세히",
"If set to \"y\", shows a list of categories in which the object is. If deletion is not disabled, it is done with the list" => "\"y\" 로 설정될 경우, 개체가 들어있는 범주의 목록을 보여줍니다. 삭제가 비활성화 되지 않은 경우, 목록으로 실행됩니다",
"Unassign" => "할당해제",
...
"Show date" => "날짜 보기",
"If set to \"y\", show post date directly instead of as tooltip" => "\"y\" 로 설정될 경우, 툴팁 대신으로써 게시 날짜를 직접 보여줍니다",
"Show time" => "시간 표시",
"Show times after dates" => "날짜 뒤에 시간 표시",
"Show author" => "작성자 표기",
"If set to \"y\", show post author directly instead of as tooltip" => "\"y\" 로 설정될 경우, 툴팁 대신으로써 게시물 저자를 직접 보여줍니다",
...
"If set to \"y\", show user avatars" => "\"y\" 로 설정될 경우, 사용자 아바타를 보여줍니다",
...
"Create links on menu sections" => "메뉴 부분에 링크 생성",
...
"Stay" => "유지",
"Stay on same page" => "동일한 페이지에 계속 있기",
...
"Tip to be shown" => "보여질 팁",
"Custom text to be shown as a tip at the top of the edit page" => "편집 페이지의 상단에 팁으로 보여질 맞춤형 텍스트",
"Title of tip to be shown" => "보여질 팁의 제목",
"Custom title to be shown for the tip at the top of the edit page" => "편집 페이지의 상단에 팁에 대하여 보여질 맞춤형 제목",
"Custom header template" => "맞춤형 헤더 템플릿",
"Wiki page to be used as a template to show content on top of edit page" => "편집 페이지 상단에 컨텐츠를 보여줄 템플릿으로 사용될 위키 페이지",
...
"If set to \"y\" shows a dropdown of sections to search" => "\"y\" 로 설정된 경우, 검색할 부분의 드롭다운을 보여줍니다",
...
"Show users" => "사용자 표시",
"If set to \"n\", do not show new users" => "\"n\" 으로 설정된 경우, 새 사용자를 보여주지 않습니다",
"Show trackers" => "트래커 표시",
"If set to \"n\", do not show tracker changes" => "\"n\"으로 설정된 경우, 트래커 변경 내역을 보여주지 않습니다",
...
"Show language" => "언어 보기",
"If \"y\" the page language will be shown instead of the page name" => "\"y\" 라면 페이지 언어가 페이지명 대신 보여지게 됨",
"Default = \"y\"" => "기본 = \"y\"",
"Tweets" => "트윗",
...
"Miscellaneous" => "기타",
"Menus" => "메뉴",
"Create and edit menus " => "메뉴 생성 및 편집",
"here" => "여기",
"Home Page" => "홈페이지",
"Redirects" => "리디렉션하기",
"Site Access" => "사이트 접근",
...
"Cclite is for creating and managing alternative or complementary trading currencies and groups" => "Cclite 는 대안 혹은 보안 거래 화폐 혹은 그룹을 생성 및 관리를 위한 것입니다.",
...
"<em>%0</em> should not be disabled due to authentication on XCache" => "<em>%0</em> 은 XCache 상의 인증때문에 사용 안 함 상태가 되지 않아야 함",
...
"Are you sure you want to apply the profile" => "프로필 적용을 계속 하시겠습니까?",
"Are you sure you want to re-apply the profile" => "프로필의 재적용을 계속하시겠습니까",
"Sending" => "전송 중",
"Waiting" => "대기 중",
...
"Check disabled plugins used in wiki pages" => "위키 페이지에 사용된 사용 안 함 상태의 플러그인들 검사",
"Disabled used plugins" => "사용된 플러그인 사용 안 함",
...
"Are you sure you want to archive this comment" => "이 댓글의 보관을 계속 하시겠습니까?",
"Are you sure you want to unarchive this comment" => "이 댓글의 보관해제를 계속하시겠습니까",
"Return" => "돌아가기",
"Do you really want to lock comments" => "댓글을 정말로 잠그시길 원하십니까",
"Lock" => "잠금",
"Do you really want to unlock comments" => "댓글을 잠금해제를 정말로 원하십니까?",
"Unlock" => "잠금해제",
"Are you sure you want to remove this comment" => "이 댓글의 삭제를 계속하시겠습니까",
"Unarchive" => "보관해제",
"Are you sure you want to approve this comment" => "이 댓글의 승인을 계속 하시겠습니까?",
"Approve" => "승인",
"Are you sure you want to reject this comment" => "이 댓글의 거부를 계속하시겠습니까",
"Reject" => "거부",
...
"Add Comment" => "댓글 추가",
"Are you sure you want to lock comments on this object" => "이 개체 상의 댓글 잠금을 계속하시겠습니까",
...
"Email:" => "전자우편:",
"Website" => "웹사이트",
"Are you sure you want to unlock comments on this object" => "이 개체의 댓글 잠금 해제를 계속하시겠습니까",
"posts" => "포스트수",
"stars" => "별",
"User Level" => "사용자 레벨",
...
"The checkbox is disabled because this preference is disabled globally." => "이 기본설정이 전역적으로 사용 안 함으로 되어있으므로 체크상자가 사용 안 함 상태가 됨.",
...
"Are you sure you want to delete the selected files" => "선택된 파일 삭제를 계속 하시겠습니까?",
"Are you sure you want to reset the default gallery list table settings" => "기본 갤러리 목록 테이블 설정의 재설정을 계속하시겠습니까",
...
"Plugin body" => "블러그인 본문",
"Last Report sent on %0" => "%0 에 보내진 마지막 보고서",
...
"File name" => "파일명",
"Wiki page %s created by {\$mail_user|username}" => "위키 페이지 %s 를 {\$mail_user|username} 님이 생성",
...
"Create a new mapfile" => "새 지도파일 생성",
...
"Stay on this page" => "이 페이지에 계속 있기",
...
"Edit existing page or create a new one" => "기존 페이지 편집 혹은 새 페이지 생성",
"Page Relations" => "페이지 관계",
"Are you sure you want to delete this shout" => "이 외침 삭제를 계속하시겠습니까",
...
"Are you sure you want to unlock this account" => "이 계정의 잠금 해제를 계속하시겠습니까",
"Are you sure you want to lock this account" => "이 계정 잠금을 계속하시겠습니까",
"delete account" => "계정 삭제",
"Are you sure, you want to delete this account" => "이 계정의 삭제를 계속하시겠습니까",
...
"before" => "이전",
"behind" => "뒤",
"Are you sure, you want to close this book" => "이 장부의 닫기를 계속하시겠습니까",
"close book" => "장부 닫기",
"Create a book" => "장부 생성",
...
"Are you sure you want to cancel this transaction" => "이 거래 취소를 계속 하시겠습니까?",
"Balance" => "균형",
"delete this transaction from the stack" => "스택에서 이 거래 삭제",
"Are you sure you want to delete this transaction from stack" => "스택에서 이 거래 삭제를 계속하시겠습니까",
"confirm this transaction" => "이 거래내역 확인",
"Are you sure you want to confirm this transaction" => "이 거래 확인을 계속 하시겠습니까?",
...
"hide topics preferences" => "주제 선호설정 감추기",
...
"hide threads preferences" => "대화목록 선호설정 감추기",
...
"New Rule" => "새 규칙",
"Copy Rules" => "규칙 복사",
"view/hide copy rules dialog" => "복사 규칙 대화상자 보기/감추기",
"Copy" => "복제",
...
"Create New Repository" => "새 리포지터리 생성",
...
"Create new Featured Link" => "새 추천 링크 생성",
...
"Edit/Create Metrics" => "메트릭 편집/생성",
"Edit/Create Tab" => "탭 편집/생성",
"Data Type" => "데이터 유형",
"Metric Name" => "메트릭명",
"Tab Name" => "탭 이름",
...
"Create new custom module" => "새 맞춤형 모듈 생성",
"Edit this custom module" => "이 맞춤형 모듈 편집",
"Create your new custom module below. Make sure to preview first and make sure all is OK before <a href=\"#assign\">assigning it</a>. Using HTML, you will be fine. However, if you improperly use wiki syntax or Smarty code, you could lock yourself out of the site" => "아래애 새 맞춤형 모듈 생성. <a href=\"#assign\">이를 할당하기</a> 전에미리보기를 먼저하고 모든 게 OK 인지 확인하십시오. HTML 을 사용하면, 별 문제 없을 것입니다. 하지만, 위키 문법 혹은 스마티 코드를 부적절하게 사용하면, 사이트가 잠겨서 들어가지 못할 수도 있습니다",
...
"You need to set <a href=\"tiki-admin.php?page=general\">Sender Email</a> before creating email notifications" => "이메일 알림을 생성하기 전에 <a href=\"tiki-admin.php?page=general\">발송자 이메일</a> 을 설정해야 합니다",
...
"Edit Feed" => "피드 편집",
"Create Feed" => "피드 생성",
"Create new external feed" => "새 외부 피드 생성",
...
"Are you sure you want to delete this word" => "이 단어 삭제를 계속하시겠습니까",
"XML Zip Import" => "XML Zip 가져오기",
"The structure" => "구조체",
"has just been created" => "이 방금 생성되었습니다",
...
"Add a New Question to this survey" => "이 설문조사에 새 질문 추가",
"Question" => "질문",
"One choice" => "한 선택",
...
"Since this Tiki site is in slave mode and imports groups, the master groups will be automatically reimported at each login" => "이 티키사이트가 슬레이브 모드에 있으며 그룹들을 불러오기 하기 때문에, 매스터 그룹들은 매 로그인시 자동적으로 다시 불러오기 됩니다",
"Since this Tiki site is in slave mode and imports preferences, the master user preferences will be automatically reimported at each login" => "이 티키 사이트가 슬레이브 모드에 있고 선호설정을 가져오기 때문에, 각 로그인 시 마스터 사용자 선호설정이 자동으로 다시불러오기 됨",
...
"Hide subcategories objects" => "하위범주 개체들 감추기",
...
"Edit or create banners" => "배너 편집 혹은 생성",
"List banners" => "배너 나열",
...
"The checkbox is disabled because feature_freetags is disabled globally" => "feature_freetags 가 전역적으로 비활성화되어있어서 체크상자가 비활성화되었습니다",
...
"Spreadsheet Creation" => "스프레드시트 생성",
...
"2 dashes" => "대시 2개",
"Headings" => "제목",
"show/hide heading section. + (shown) or - (hidden) by default" => "제목 섹션 보이기/감추기 + (보임) 혹은 - (감춤) 이 기본",
...
"Indentation" => "들여쓰기",
"Creates an indentation for each plus (useful in list to continue at the same level)" => "각 더하기에 대하여 들여쓰기를 생성 (목록 안에서 동급에서 계속하기에 유용함)",
"Tables" => "표",
"col" => "열",
...
"My Footnotes" => "내 각주",
"Use rating" => "등급 사용",
"You should ask an admin to create them" => "관리자에게 생성을 요청하셔야 합니다",
...
"Admin Quizzes" => "퀴즈 관리",
"Create/edit options for question" => "질문에 대한 선택사항 생성/편집",
"points" => "점수",
"Edit quiz questions" => "퀴즈 질문 편집",
"Create/edit questions for quiz" => "퀴즈에 대한 질문 생성/편집",
"Question Type" => "질문 유형",
...
"%0 pages imported from a total of %1" => "%0 페이지들이 총 %1에서 가져오기 됨",
...
"%0 posts imported" => "%0 게시물들이 불러오기됨",
"%0 tags imported" => "%0 태그들 불러오기됨",
"%0 categories imported" => "%0 범주들이 가져오기 됨",
"Importer log" => "불러오기 기록",
...
"You must create the database and user <em>before</em> completing this page" => "이 페이지를 완료하기 <em>이전에</em> 데이터베이스와 사용자를 반드시 생성해야 합니다",
...
"Create the <em>Admins</em> group, if missing" => "<em>Admins</em> 그룹 생성, 없을 경우에만 해당",
...
"Check this box if you have a lot of disabled accounts after an upgrade to tiki4" => "티키4로 업그레이드한 후 사용 안 함 상태의 계정이 많을 경우 이 상자를 체크하시오",
...
"Are you sure you want to attempt to fix the encoding of your entire database" => "데이터베이스 전체의 인코등 수정 시도를 계속 하시겠습니까?",
...
"Create content block" => "컨텐츠 블럭 생성",
...
"Create a Gallery" => "갤러리 생성",
"Duplicate Gallery" => "갤러리 복제",
"Admin View" => "관리자 보기",
"Create Drawing" => "드로잉 생성",
...
"Create page within %0" => "%0 내부에 페이지 생성",
"Blog: %0" => "블로그: %0",
...
"Use \"Tracker -> Export -> Structure\" to produce this data" => "이 데이터를 생성하려면 \"트래커 -> 내보내기 -> 구조체\" 를 사용",
...
"You will probably find mods shown as being compatible with older versions of Tiki will work with later versions with little or no modification" => "티키의 구버전과 호환성을 지닌 것으로 보여지는 mod들이 이후 버전들과 약간의 수정 혹은 수정 없이 작동하는 것을 확인하실 수 있으실 것입니다",
...
"Show permissions for disabled features" => "사용 안 함 상태가된 기능에 대한 권한 보기",
"Feature name" => "기능 이름",
...
"Hide translation history" => "번역 기록 감추기",
...
"votes" => "투표",
"Poll Results" => "투표 결과",
"Top Voted Polls" => "가장 많이 투표된 투표조사들",
"Edit Poll" => "투표 편집",
"Find the poll" => "투표 찾기",
"Number of top voted polls to show" => "보여질 최고 참여 투표의 수",
...
"Clip Now" => "지금 클립",
"Clip Articles" => "기사 클립",
"Be careful not to paste articles that must not be seen by the recipients" => "수신자에게 보여서는 안되는 기사를 붙여넣지 않도록 조심하십시오",
"Attached Files" => "첨부된 파일",
"remove" => "제거",
"octets" => "8진수",
...
"Paused to resume press the play button" => "멈쳐짐. 재생 버튼을 눌러 계속",
...
"Created at" => "생성된 시기",
"Are you sure you want to delete all tasks" => "모든 작업 삭제를 계속 하시겠습니까?",
...
"Creator of file, if different from the 'Uploaded by' user" => "파일의 생성자, 만약 '업로드 하신 분' 사용자와 다를 경우에 해당",
...
"You have to create a gallery first" => "갤러리부터 먼저 생성해야 합니다",
...
"Task user" => "작업 사용자",
"Only the creator can delete this task" => "생성자만이 이 작업을 삭제할 수 있습니다",
...
"No / Rejected" => "아니오 / 거절됨",
"Accepted by Creator" => "생성자에 의해 승인됨",
...
"Accepted by task user and creator" => "작업 사용자와 생성자에 의해 승인됨",
...
"Task has been accepted by user and creator" => "작업이 사용자와 생성자에 의하여 승인되었습니다",
...
"Show All" => "전체 표시",
"Hides or shows the currently selected row" => "현재 선택된 행 보이기 혹은 감추기",
...
"Hides or shows the currently selected column" => "현재 선택된 열 감추기 혹은 보이기",
...
"Hide structure bar" => "구조체 바 감추기",
"Hide structure" => "구조체 감추기",
...
"Editable by administrators and creator only" => "관리자와 생성자만 편집 가능",
"Immutable after creation" => "만들기 후 변경 불가능함",
"Creator requires a user field with auto-assign to creator (1)" => "생성자는 생성자 (1) 에게 자동할당되는 사용자 필드가 필요합니다",
"Visible by" => "다음에게 보임",
...
"Create as new items" => "새 항목으로 생성",
"Update lastModif date if updating items (status and created are updated only if the fields are specified in the csv)" => "만약 항목을 갱신한다면, lastModif (마지막 수정) 날짜 갱신 (상태와 생성됨은 필드가 csv 내부에 지정되어 있을 경우에만 갱신)",
"Convert values of ItemLink type fields from the value in the CSV file to the itemId of the linked item. Requires the linked item to be correctly set up in advance" => "ItemLink 유형 필드의 값을 CSV 파일 내부의 값에서 링크된 항목의 itemId 로 변환. 링크된 항목이 사전에 올바르게 설정되어있어야만 함이 필수",
"Import fields for this tracker" => "이 트래커에서 필드 가져오기",
"Are you sure you want to remove the fields? Data will be lost" => "필드 삭제를 계속하시겠습니까? 데이터가 손실될 것입니다",
"Remove Fields" => "필드 제거",
"Return to field administration" => "필드 관리로 돌아가기",
"Are you sure you want to delete this item" => "이 항목 삭제를 계속 하시겠습니까",
"Delete item" => "항목 삭제",
...
"Creation date constraint" => "생성 날짜 제약 조건",
"Auto-create corresponding categories" => "상응하는 범주들을 자동 만들기",
"Create a group for each item" => "각 항목에 대하여 그룹 생성",
"Groups will include" => "그룹은 다음을 포함합니다",
"Creator is assigned to the group" => "생성자가 그룹에 할당되었습니다",
...
"Select Icon" => "아이콘 선택",
"Remove Image" => "그림 제거",
"Are you sure you want to delete this image" => "이 그림 삭제를 계속 하시겠습니까",
...
"Are you sure you want to detach these translations" => "이 번역들의 분리를 계속하시겠습니까",
"Current translation set" => "현재 번역 설정",
"Are you sure you want to detach the translation" => "이 번역 분리를 계속하시겠습니까",
...
"Creator &amp; Last Editor" => "생성자 &amp; 마지막 편집자",
"as Creator &amp; Last Editor" => "생성자 &amp; 마지막 편집자로써",
"no (disabled)" => "아니오 (사용 안 함)",
"Page approved by %0 on %1" => "페이지가 %0님에 의하여 %1에 승인되었습니다",
"Page last modified on %0 by %1" => "페이지는 %0 에 %1 님에 의하여 최종 수정되었습니다",
"Created by %0" => "%0 님이 생성함",
...
"You do not have permissions to create a book" => "책을 생성할 권한이 없습니다",
...
"Error retrieving data from journal" => "저널에서 데이터 불러오기 오류",
...
"Are you sure you want to unassign the objects of this category: " => "다음 범주의 개체 할당해제를 계속하시겠습니까:",
...
"Reads (desc)" => "열람수 (내림차순)",
"Are you sure you want to create a new group" => "새 그룹 생성을 계속 하시겠습니까?",
"Are you sure you want to add this user" => "이 사용자 추가를 하시겠습니까",
"Are you sure you want to ban the user \"%0\" from the group \"%1\"" => "\"%0\" 사용자를 \"%1\" 그룹에서 차단을 계속 하시겠습니까?",
"Are you sure you want to unban the user \"%0\" from the group \"%1\"" => "\"%1\" 그룹에서 \"%0\" 사용자의 차단해지를 계속하시겠습니까",
"Group already exists" => "그룹 이미 존재",
"Remove group: " => "그룹 제거:",
"Are you sure you want to unassign these users" => "이 사용자들의 할당해제를 계속하시겠습니까",
"Are you sure you want to delete these groups" => "이 그룹들의 삭제를 계속 하시겠습니까?",
...
"Are you sure you want to delete menu id" => "메뉴 id 삭제를 계속 하시겠습니까?",
"Are you sure you want to reset the Application Menu to the current system default" => "현재 시스템 기본으로 응용프로그램 재설정을 계속하시겠습니까",
...
"Memcache is disabled for metrics" => "멤캐시는 메트릭에 대하여 비활성화되었습니다",
...
"Cannot create or update metric: You need to specify a name for the metric" => "메트릭 생성 혹은 갱신 불가: 메트릭에 대한 이름 지정 필요",
"Cannot create or update metric: Metric name must be under %0 characters in length" => "메트릭 생성 혹은 갱신 불가: 메트릭 이름은 글자 수 길이가 %0 미만이어야만 함",
"Cannot create or update metric: You need to specify a range for the metric" => "메트릭 생성 혹은 갱신 불가: 메트릭에 대한 범위 지정 필요",
"Cannot create or update metric: You need to specify a data type for the metric" => "메트릭 생성 혹은 갱신 불가: 메트릭에 대한 데이터 유형 지정 필요",
"Cannot create or update metric: You need to specify a query for the metric" => "메트릭 생성 혹은 갱신 불가: 메트릭에 대한 질의 지정 필요",
"Cannot create or update tab: You need to specify a name for the tab" => "탭을 생성하거나 갱신 불가: 탭에 대한 이름을 지정해야 합니다",
"Cannot create or update tab: Tab name must be under %0 characters in length" => "탭 생성 혹은 갱신 불가: 탭 이름은 글자 수 길이가 %0 미만이어야만 함",
"Cannot create or update tab: You need to specify an integer range for the tab order" => "탭을 생성하거나 갱신 불가: 탭 순서에 대한 정수 범위를 지정해야 합니다",
"Cannot create or update tab: Tab content cannot be empty" => "탭 생성 혹은 갱신 불가: 탭 내용물은 비어있을 수 없음",
"Cannot create or update module: You need to specify a name for the module" => "모듈 생성 혹은 갱신 불가: 모듈에 대한 이름 지정 필요",
"Cannot create or update module: You cannot leave the data field empty" => "모듈 생성 혹은 갱신 불가: 데이터 필드를 빈 공간으로 남겨둘 수 없음",
"A module with that \"name\" already exists, please choose another" => "해당 \"이름\"을 가진 모듈이 이미 존재하오니 다른 것을 선택하여 주십시오",
"Are you sure you want to delete this Custom Module" => "이 사용자 지정 모듈 삭제를 계속 하시겠습니까?",
...
"No survey indicated" => "지정된 설문조사 없음",
"Tiki Cache/Sys Admin" => "티키 캐시/시스템 관리",
"Global" => "전역",
"WYSIWYG Plugin" => "WYSIWYG 플러그인",
"Are you sure you want to delete all your custom tools" => "사용자 지정 도구 전체 삭제를 계속 하시겠습니까?",
"Are you sure you want to delete this custom tool" => "이 사용자 지정 도구 삭제를 계속 하시겠습니까",
"Are you sure you want to remove this topic" => "이 토픽의 삭제를 계속하시겠습니까",
"Are you sure you want to remove this topic AND all the articles related" => "이 토픽 및 모든 관련된 기사들의 삭제를 계속하시겠습니까",
...
"Created account %s <%s>" => "계정 %s <%s> 생성됨",
"Assigned %s in group %s" => "%s 를 %s 그룹 안으로 할당함",
"Are you sure you want to add this new user" => "이 새 사용자 추가를 계속 하시겠습니까",
...
"New user created with username %s" => "새 사용자가 유저명 %s 로 생성됨",
"Impossible to create new %s with %s %s" => "새 %s 를 %s %s 과 함께 만드는 것은 불가능합니다",
"Are you sure you want to delete this user" => "이 사용자 삭제를 계속하시겠습니까",
"%s %s successfully deleted" => "%s %s 가 성공적으로 삭제됨",
"Deleted account %s" => "삭제된 계정 %s",
"Are you sure you want to remove the admin user from the Admins group? You may not be able to administer your Tiki any more if you do this" => "관리 그룹으로부터 관리 사용자의 삭제를 계속하시겠습니까",
...
"Are you sure you want to reset email due for this user" => "이 사용자에 대한 이메일 재설정을 계속하시겠습니까",
"Are you sure you want to remove the link with OpenID for this user" => "이 사용자에 대하여 OpenID 와 함께 링크 삭제를 계속하시겠습니까",
"Are you sure you want to delete these users" => "이 사용자들의 삭제를 계속 하시겠습니까?",
"Are you sure you want to add this user to these groups" => "이 그룹들에 이 사용자 추가를 하시겠습니까",
"%s %s assigned to %s %s" => "%s %s이 %s %s로 할당됨",
"Are you sure you want to remove this user from these groups" => "이 그룹들로부터 이 사용자의 삭제를 계속하시겠습니까",
...
"Are you sure you want to send a wiki page as an email to these users" => "이 사용자들에게 이메일로 위키 페이지 전송을 계속하시겠습니까",
...
"Could not create user" => "사용자를 생성할 수 없었습니다",
"Are you sure you want to modify this user's data" => "이 사용자 데이터의 수정을 계속하시겠습니까",
...
"You need to <a href=\"tiki-admin_calendars.php?cookietab=2\">create a calendar</a>" => "<a href=\"tiki-admin_calendars.php?cookietab=2\">달력 생성</a> 을 해야할 필요가 있습니다",
...
"Creating directory structure in <strong>%0</strong>" => "<strong>%0</strong> 내부에 디렉터리 구조체 생성 중",
...
"You have to create a topic first" => "토픽부터 먼저 생성해야 합니다",
...
"Last replied forum topics" => "마지막 답글이 달린 게시판 토픽",
...
"last image" => "마지막그림",
"random image" => "무작위 그림",
"You do not have permission to create galleries and so you cannot edit them" => "갤러리를 생성할 권한이 없습니다 그래서 편집할 수 없습니다",
...
"Are you sure you want to permanently remove the article with identifier %0" => "%0 식별자를 가진 기사의 영구 삭제를 계속하시겠습니까",
"Are you sure you want to permanently remove these %0 articles" => "다음 %0 기사들의 영구 삭제를 계속하시겠습니까",
...
"Are you sure you want to remove the %0 selected pages" => "%0 선택된 페이지들의 삭제를 계속하시겠습니까",
"Are you sure you want to print the %0 selected pages" => "%0 선택된 페이지들의 인쇄를 계속하시겠습니까",
"Are you sure you want to unlock the %0 selected pages" => "%0 선택된 페이지들의 잠금 해제를 계속하시겠습니까",
"Are you sure you want to lock the %0 selected pages" => "%0 선택된 페이지들의 잠금을 계속하시겠습니까",
"Are you sure you want to download a zip of the %0 selected pages" => "%0 선택된 페이지들의 zip 다운로드를 계속하시겠습니까",
"Are you sure you want to modify the %0 pages" => "%0 페이지들의 수정을 계속하시겠습니까",
"No history will be created" => "기록이 생성되지 않을 것입니다",
"Delete posts" => "게시물 삭제",
"View submissions" => "투고기사 보기",
"Are you sure you want to permanently remove the submitted article with identifier %0" => "%0 식별자를 가진 제출된 기사의 영구 삭제를 계속하시겠습니까",
"Are you sure you want to permanently remove these %0 submitted articles" => "다음의 %0 제출된 기사들의 영구삭제를 계속하시겠습니까",
"Are you sure you want to approve these %0 submitted articles" => "%0 제출된 기사들의 승인을 계속 하시겠습니까?",
...
"Please create a directory named %0 to hold your map files" => "맵파일을 저장할 %0 라고 명명된 디렉터리를 생성해 주십시오",
...
"Are you sure you want to delete this note" => "이 메모 삭제를 계속하시겠습니까",
"created from notepad" => "메모장에서 생성됨",
...
"Are you sure you want to remove the direct permissions from this object" => "이 개체로부터 직접 권한의 삭제를 계속하시겠습니까",
"Are you sure you want paste the copied permissions onto this object" => "이 개체로 복사된 권한을 붙이기를 계속 하시겠습니까",
...
"Spreadsheet - " => "스프레드시트 -",
"Are you sure you want to delete this spreadsheet" => "이 스프레드시트 삭제를 계속하시겠습니까",
...
"Are you sure you want to clear all statistics and data for this survey" => "이 설문조사에 대한 통계와 데이터 삭제를 계속 하시겠습니까?",
...
"END" => "종료",
"Percentage" => "백분율",
"Task accepted by creator" => "생성자에 의해 승인된 작업",
...
"Are you sure you want to clone this spreadsheet" => "이 스프레드시트 복제를 계속 하시겠습니까?",
"Clone Error" => "복제 오류",
"Are you sure you want to rollback this spreadsheet" => "이 스프레드시트의 롤백을 계속하시겠습니까",
...
"Create tracker item" => "트래커 항목 생성",
"Admin this tracker" => "이 트래커 관리",
"Are you sure you want to remove this attachment" => "이 첨부파일의 삭제를 계속하시겠습니까",
"Edit/Delete" => "편집/삭제",
...
"Mail ID" => "메일 ID",
"Are you sure you want to delete this account" => "이 계정의 삭제를 계속 하시겠습니까?",
