...
// $Id: imagegallib.php 45573 2013-04-18 15:04:20Z lphuberdeau $
...
#get image and other infos
    ...
    function list_galleries($offset = 0, $maxRecords = -1, $sort_mode = 'name_desc', $user = '', $find = null)
	{
		...
		if (in_array($sort_mode, array('images_desc', 'images_asc'))) {
			$old_offset = $offset;
		...
		if (in_array($old_sort_mode, array('images_desc', 'images_asc'))) {
