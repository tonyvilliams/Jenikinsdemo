...
// $Id: messulib.php 45199 2013-03-19 14:28:32Z jonnybradley $
...
class Messu extends TikiLib
{
	 ...
	 */
	function list_user_messages($user, $offset, $maxRecords, $sort_mode, $find,
		$flag = '', $flagval = '', $prio = '', $dbsource, $replyto_hash = '',
		$orig_or_reply = 'r')
	{
		if ($dbsource == '')
			$dbsource = 'messages';
